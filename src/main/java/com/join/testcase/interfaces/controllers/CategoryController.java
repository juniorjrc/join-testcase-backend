...
import com.join.testcase.application.services.JoinTestCaseService;
...
@AllArgsConstructor
public class CategoryController implements JoinTestCaseController<CategoryDTO, CategoryUpdateRequestDTO> {
    ...
    private final JoinTestCaseService<CategoryDTO, CategoryUpdateRequestDTO> service;
